...
html_options_create::html_options_create():
    ...
    delta_fs(""),
    delta_sig("Compute binary delta signature", html_form_input::check, "", "", ""),
    archgen_fs(""),
    ...
    user_comment("User comment in slice header", html_form_input::text, "", "", webdar_css_style::width_80vw),
    sparse_file_min_size("Minimum size of holes to lookup in sparse files", 0, "10"),
    hash_algo("Hashing algorithm"),
    execute("Command to execute after each slice", html_form_input::text, "", "", webdar_css_style::width_80vw),
    ...
    display_dir_summary("Display summary at the end of each directory", html_form_input::check, "", "", ""),
    ...
    dont_ignore_unknown_inode_type("Do not ignore unknown inode type instead of warning", html_form_input::check, "1", "", ""),
    perimeter_fs(""),
    ...
    exclude_by_ea("enable", html_form_input::check, "1", "", ""),
    default_ea("Use the default excluding Extended Attribute", html_form_input::check, "1", "", ""),
    exclude_by_ea_name("Extended Attribute name", html_form_input::text, "", "", webdar_css_style::width_80vw),
    fs_alter_atime("What to alter if furtive read mode is not used"),
    furtive_read_mode("Furtive read mode (if available)", html_form_input::check, "", "", ""),
    zeroing_neg_date("Automatically zeroing negative dates while reading", html_form_input::check, "", "", ""),
