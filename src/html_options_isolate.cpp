...
html_options_isolate::html_options_isolate():
    ...
    delta_fs(""),
    delta_sig("Transfer binary delta signature", html_form_input::check, "", "", ""),
    delta_transfer_mode("Compute delta signature when they are missing", html_form_input::check, "", "", ""),
    form_archgen("Update"),
    fs_archgen(""),
    ...
    repair_mode("Repair mode", html_form_input::check, "", "", ""),
    form_shown("Update"),
    fs_shown(""),
