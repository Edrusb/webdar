...
html_entrepot::html_entrepot():
    ...
    pass("Password", html_form_input::password, "", "", webdar_css_style::width_80vw),
    auth_from_file("Fetch password from netrc file", html_form_input::check, "", "", ""),
    pub_keyfile("Public key file", "/", "", webdar_css_style::width_80vw, "Select the public key file..."),
    prv_keyfile("Private key file", "/", "", webdar_css_style::width_80vw, "Select the private key file..."),
    knownhosts_check("Check remote host from the known-hosts file", html_form_input::check, "1", "", ""),
    known_hosts_file("Known-hosts file", "/", "", webdar_css_style::width_80vw, "Select the knowhosts file..."),
