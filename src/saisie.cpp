    ...
    go_repair("Repair", event_repair)
{
    ...
    choice.add_entry("Create", menu_create);
    select.add_section(menu_create, "");
    choice.add_entry("Test", menu_test);
    select.add_section(menu_test, "");
    choice.add_entry("Compare", menu_compare);
    select.add_section(menu_compare, "");
    choice.add_entry("List", menu_list);
    select.add_section(menu_list, "");
    choice.add_entry("Isolate", menu_isolate);
    select.add_section(menu_isolate, "");
    choice.add_entry("Merge", menu_merge);
    select.add_section(menu_merge, "");
    choice.add_entry("Repair", menu_repair);
    select.add_section(menu_repair, "");
    choice.add_entry("Restore", menu_restore);
    select.add_section(menu_restore, "");
    choice.add_entry("", "");
    select.add_section("sep2", "");
    choice.add_entry("Configure", menu_biblio);
