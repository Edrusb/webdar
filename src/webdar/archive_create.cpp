...
archive_create::archive_create(const archive_create & ref):
...
string archive_create::get_body_part(const chemin & path,
				     const request & req)
{
...
void archive_create::on_event(const std::string & event_name)
{
